  ...
  return (
    ...
    >
      <div className="relative w-full dark:bg-black bg-white">
        ...
        <div className="flex justify-center sm:justify-end gap-2 mr-10">
          <button
...
export const Card = ({ card, index, layout = false }) => {
  return (
    ...
    className="rounded-3xl bg-transparent h-60 w-40 md:h-[20rem] border-[1px] border-black dark:border-white md:w-64 overflow-hidden flex flex-col items-start justify-start relative z-10"
    >
        ...
        <div className="relative z-40 p-4">
          ...
          <motion.p
            ...
            className="text-black dark:text-white text-xl md:text-2xl font-semibold max-w-xs text-left [text-wrap:balance] font-sans mt-2"
          >
            {card.title}
          </motion.p>
        </div>
