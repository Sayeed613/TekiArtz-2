  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg text-start md:text-4xl mb-4 text-[#0b726f]  max-w-4xl">
        Master Your Software Development Project.
        </h2>
        <p
          className="text-neutral-700 text-start dark:text-neutral-300 text-sm md:text-base max-w-sm">
          From conception to completion, our team brings your bold ideas to life.
        </p>
      </div>
